...
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] The deployed application can be accessed at: http://camel-quarkus-jsonvalidation-api-camel-quarkus-jvm.apps.jeannyil.sandbox1047.opentlc.com
...
3. Test the `/openapi.json` endpoint
    ...
    ```json
    {
        ...
        "servers": [
            {
                "url": "http://camel-quarkus-json-validation-api.apps.jeannyil.sandbox1047.opentlc.com",
