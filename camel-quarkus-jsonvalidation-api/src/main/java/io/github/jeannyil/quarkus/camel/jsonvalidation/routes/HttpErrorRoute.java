...
public class HttpErrorRoute extends RouteBuilder {
	...
	public void configure() throws Exception {
		 ...
		 * <br>- errorId ({@link io.github.jeannyil.quarkus.camel.jsonvalidation.constants.APIConstants#ERROR_ID})
		 * <br>- errorDescription ({@link io.github.jeannyil.quarkus.camel.jsonvalidation.constants.APIConstants#ERROR_DESCRIPTION })
		 * <br>- errorMessage ({@link io.github.jeannyil.quarkus.camel.jsonvalidation.constants.APIConstants#ERROR_MESSAGE })
		 * <br>- httpStatusCode ({@link io.github.jeannyil.quarkus.camel.jsonvalidation.constants.APIConstants#HTTP_STATUS_CODE })
		 * <br>- httpStatusMsg ({@link io.github.jeannyil.quarkus.camel.jsonvalidation.constants.APIConstants#HTTP_STATUS_MSG })
		 */
