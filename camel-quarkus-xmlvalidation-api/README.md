...
[INFO] [io.quarkus.kubernetes.deployment.KubernetesDeployer] The deployed application can be accessed at: http://camel-quarkus-xmlvalidation-api-camel-quarkus-jvm.apps.jeannyil.sandbox1444.opentlc.com
...
3. Test the `/openapi.json` endpoint
    ...
    ```json
    {
        ...
        "servers": [
            {
                "url": "https://camel-quarkus-xml-validation-api.apps.jeannyil.sandbox1444.opentlc.com"
            }
        ],
        "paths": {
