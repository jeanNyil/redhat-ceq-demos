...
/* Exposes the DataGridTester RESTful API with a Contract/API-First approach
...
@ApplicationScoped
public class DataGridTesterApi extends RouteBuilder {
    private static String logName = DataGridTesterApi.class.getName();
