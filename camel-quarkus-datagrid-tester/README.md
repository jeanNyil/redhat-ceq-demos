...
- A truststore containing the [_Red Hat Data Grid v8.3_](https://access.redhat.com/documentation/en-us/red_hat_data_grid/8.3) server public certificate. Below are sample command lines to generate one:
    ...
    ```
    with `<Red Hat Data Grid cluster OpenShift route>`: OpenShift route hostname for the Red Hat Data Grid cluster. E.g.: `datagrid-cluster.apps.cluster-njnx5.njnx5.sandbox969.opentlc.com`
...
--production-public-base-url='https://rhdg-fruits-and-legumes-api.apps.cluster-njnx5.njnx5.sandbox969.opentlc.com'  \
--staging-public-base-url='https://rhdg-fruits-and-legumes-api-staging.apps.cluster-njnx5.njnx5.sandbox969.opentlc.com'  \
--oidc-issuer-type=keycloak \
--oidc-issuer-endpoint='https://rhpds-3scale-apim-demo-zync:TgEJ50Qr5iz6KN0xRLm3TCampSXZoiYK@sso.apps.cluster-njnx5.njnx5.sandbox969.opentlc.com/auth/realms/openshift-cluster' \
